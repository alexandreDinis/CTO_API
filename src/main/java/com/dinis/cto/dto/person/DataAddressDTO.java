...
public record DataAddressDTO(@NotBlank String street, String number, String neighborhood, @NotBlank String city,
                             @NotBlank String state, @NotBlank(message = "CEP não pode ser vazio")
